...
public class MateriaControllerTest {
    ...
    public void crearMateriaConNombreYaExistente() throws Exception {
        Mockito.when(materiaService.crearMateria(any(MateriaDto.class))).thenThrow(new MateriaConNombreYaCreadoException("Ya existe una materia con el nombre: Laboratorio II."));
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/materia")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\n" +
                        "    \"nombre\" : \"Laboratorio II\",\n" +
